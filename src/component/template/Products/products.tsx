...
export const Products: React.FC = () => {
  const ScrollRevealContainer = dynamic<any>(
    () =>
      import('@/component/organism/ScrollRevealContainer').then(
        (module) => module.ScrollRevealContainer,
      ),
    { ssr: false },
  );
  return (
      ...
      <ScrollRevealContainer>
        <div className='mx-auto mt-20 w-10/12'>
          <div className='mx-auto'>
            <h2 id='product' className='title py-24'>
              PRODUCTS
            </h2>
